...
2. Use librarian-ansible by creating an AnsibleFile in the top level of the repository and kitchen-puppet will automatically call librariab-ansible as part of the converge. For a description of setting up an AnsibleFile see:  https://werner-dijkerman.nl/2015/08/15/using-librarian-ansible-to-install-ansible-roles-from-gitlab/
