...
2. Use librarian-ansible by creating an AnsibleFile in the top level of the repository. For a description of doing this see:  https://werner-dijkerman.nl/2015/08/15/using-librarian-ansible-to-install-ansible-roles-from-gitlab/
